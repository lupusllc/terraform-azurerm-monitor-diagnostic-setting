...
This [public repo](https://github.com/lupusllc/terraform-azurerm-monitor-diagnostic-setting) is the source for this public Terraform module.
...
monitor-diagnostic-settings | no | list(object()) | [] | [Example](#arguments-monitor-diagnostic-settings-example) | A list of objects, used to create zero or more resource groups.
...
## Arguments: monitor-diagnostic-settings
  
The monitor-diagnostic-settings list of objects defines the resource groups to be created.
  
Arguments | Required | Type | Default | Example | Description
--------- | -------- | ---- | ------- | ------- | -----------
location | yes* | string | | [Example](#arguments-monitor-diagnostic-settings-example) | Resource location.
name | yes | string | | [Example](#arguments-monitor-diagnostic-settings-example) | Resource name.
tags | no | map(string) | | [Example](#arguments-monitor-diagnostic-settings-example) | Resource tags, these tags will be combined with required tags if provided.
  
\* These are only required if defaults do not provide these values.
  
### Arguments: monitor-diagnostic-settings: Example
