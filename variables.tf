...
variable "monitor_diagnostic_settings" {
  ...
  type = list(object({
    ...
    name                                        = optional(string, "default") # The name of the diagnostic setting. Default is default.
    ...
    target_name                                 = optional(string, null)      # The target resource name.
    target_resource_id                          = string                      # The target resource ID.
    target_resource_group_name                  = optional(string, null)      # The target resource group name.
    target_sub_resource_path                    = optional(string, null)      # The target sub resource path.
  }))
}
